 ...
 *
 * Useful whenever you ship customer addresses to a third party (a payment
 * processor, tax service, or carrier). Most gateways are happiest with
 * 2-letter codes — some hard-reject long values, and AVS matching is most
 * reliable when the 2-letter code is sent, so a full-name state can pass
 * auth but fail AVS on the back-end and raise chargebacks.
 *
 ...
 * pass *something* to a strict gateway — a malformed value beats a 400
 * from the processor.
 *
